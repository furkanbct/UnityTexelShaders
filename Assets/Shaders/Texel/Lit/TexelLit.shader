Shader "Universal Render Pipeline/TexelLit"
{
    Properties
    {
        ...
        [HideInInspector] _BlendModePreserveSpecular("__blendModePreserveSpecular", Float) = 1.0
        ...
        [HideInInspector] _QueueControl("Queue control", Float) = -1.0
    }
    ...
    CustomEditor "TexelLitShaderGUI"
}